...
*/
	...
	public $driver;
	public $drivers=["Digest"   => ["digest_sasl_client_class", "digest_sasl_client.php"], "CRAM-MD5" => ["cram_md5_sasl_client_class", "cram_md5_sasl_client.php"], "LOGIN"    => ["login_sasl_client_class", "login_sasl_client.php"], "NTLM"     => ["ntlm_sasl_client_class", "ntlm_sasl_client.php"], "PLAIN"    => ["plain_sasl_client_class", "plain_sasl_client.php"], "Basic"    => ["basic_sasl_client_class", "basic_sasl_client.php"]];
	public $credentials=[];
